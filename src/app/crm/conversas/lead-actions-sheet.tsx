...
const PIPELINE = [
  ...
  { value: "proposal", emoji: "💰", label: "Avaliação" },
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 inset-x-0 z-50 bg-white rounded-t-2xl shadow-xl pb-[max(env(safe-area-inset-bottom),12px)] max-h-[85vh] overflow-y-auto"
          >
            ...
            <Section title="Ações rápidas">
              <div className="px-3 grid grid-cols-4 gap-1.5">
                <QuickAction
                  ...
                  onClick={() =>
                    onAction({ kind: "pin", value: !lead.pinned })
                  }
                />
                <QuickAction
                  emoji="⏰"
