  ...
  return (
    <FadeUp className="flex-1 flex flex-col">
      <div className="flex-1 flex flex-col">
        ...
        <h1
          className="font-[family-name:var(--font-geist-sans)] font-medium leading-[1.15] mb-4"
          style={{
...
function QuestionScreen({
  ...
  return (
    <FadeUp className="flex-1 flex flex-col justify-center">
      ...
      {question.subtitle && (
        <p
          className="text-sm italic leading-relaxed mb-7 font-[family-name:var(--font-geist-sans)]"
          style={{ color: "var(--sakura-cocoa-3)" }}
        >
          {question.subtitle}
        </p>
...
function LoadingScreen() {
  return (
    <FadeUp className="flex-1 flex flex-col justify-center">
      ...
      <h2
        className="font-[family-name:var(--font-geist-sans)] leading-[1.15] mb-8"
        style={{
...
function ResultScreen({
  ...
  return (
    <FadeUp className="flex-1 flex flex-col">
      ...
      <h2
        className="font-[family-name:var(--font-geist-sans)] leading-[1.1] mb-5"
        style={{
